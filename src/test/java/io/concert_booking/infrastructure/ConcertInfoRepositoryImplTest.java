...
class ConcertInfoRepositoryImplTest {
    ...
    void getConcertInfoTest() {
        ...
        // when
        Throwable throwable = assertThrows(EntityRowNotFoundException.class, () -> concertInfoRepository.getConcertInfoById(concertInfoId));

        // then
        assertEquals("해당 콘서트 정보를 찾을 수 없습니다.", throwable.getMessage());
    }
